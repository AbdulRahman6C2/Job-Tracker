...
PORT=3001
**Frontend** (`.env`)
VITE_API_URL=http://localhost:3001/applications
...
- Verify the backend loads without errors

## Author

Mohammed Abdul Rahman
[GitHub](https://github.com/AbdulRahman6C2) · [LinkedIn](https://linkedin.com/in/abdulrahman005/)